			...
			<div class="right-response">
				<section class="case">
					...
					<select class="w200" name="case-type">
						<option value ="/page/cases/ui">UI</option>
						<option value ="/page/cases/vis" selected = "selected">VIS</option>
					</select>	
				</section>
				
				<iframe id="upframe" name="upframe" src="" style="display:none;"></iframe>
				<table class="mt40 vis-table">
				<tr>
				...
				<form action="/page/set_cases/vis/1" enctype="multipart/form-data" method="post" target="upframe">
				<tr>
				...
				<form action="/page/set_cases/vis/2" enctype="multipart/form-data" method="post" target="upframe">
				<tr>
				...
				<form action="/page/set_cases/vis/3" enctype="multipart/form-data" method="post" target="upframe">
				<tr>
				...
				<form action="/page/set_cases/vis/4" enctype="multipart/form-data" method="post" target="upframe">
				<tr>
				...
				<form action="/page/set_cases/vis/5" enctype="multipart/form-data" method="post" target="upframe">
				<tr>
				...
				<form action="/page/set_cases/vis/6" enctype="multipart/form-data" method="post" target="upframe">
				<tr>
